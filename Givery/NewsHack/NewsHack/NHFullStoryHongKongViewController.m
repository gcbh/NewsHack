...
@interface NHFullStoryHongKongViewController ()

@end

@implementation NHFullStoryHongKongViewController {
...
- (UICollectionViewCell*)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.section) {
        case 0:
            [image setImage:[UIImage imageNamed:@"detail_01_a.png"]];
            break;
        case 1:
            [image setImage:[UIImage imageNamed:@"detail_01_b.png"]];
            break;
        case 2:
            [image setImage:[UIImage imageNamed:@"detail_01_c.png"]];
            break;
        case 3:
            [image setImage:[UIImage imageNamed:@"detail_01_d.png"]];
            break;
        case 4:
            [image setImage:[UIImage imageNamed:@"detail_01_e.png"]];
            break;
        default:
            break;
    }
...
- (void)backButton {
//[self presentViewController:[[NHNewsViewController alloc]init]animated:YES completion:nil];
